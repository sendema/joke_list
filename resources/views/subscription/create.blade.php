...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card bg-dark"> <!-- Добавлен темный фон -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card h-100 bg-dark"> <!-- Добавлен темный фон -->
                                    <div class="card-body text-center">
                                        ...
                                        <ul class="list-unstyled mb-4 text-white">
                                            ...
                                            <li class="invisible">.</li> <!-- Для выравнивания высоты -->
                                        </ul>
                            ...
                            <!-- Годовая подписка -->
                            <div class="col-md-6 mb-4">
                                <div class="card h-100 bg-dark border-light"> <!-- Добавлен темный фон -->
                                    <div class="card-body text-center">
